...
public class calendarExampleActivity extends AppCompatActivity {
    private static final String TAG = "calendarExampleActivity";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState, @Nullable PersistableBundle persistentState) {
        ...
        setContentView(R.layout.calendar_example);
    ...
    private void populateCalendarSpinner() {
        ...
        m_spinner_calender.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> p_parent, View p_view,
                ...
                Log.d(TAG, "calendar was selected ");
            }
            @Override
    ...
    /**
     * Query the android calendar provider and go through the calendar list returned.
     * Stores the name and id of each calendar in the global variable m_calendars[].
     */
    private void getCalendars(){
        ...
        //Cursor l_managedCursor = getContentResolver().query(l_calendars, l_projection, "selected=1", null, null);   //active calendars
    ...
    private void getLastThreeEvents() {
        ...
        //Cursor l_managedCursor = getContentResolver().query(l_eventUri, l_projection, null, null, null);
